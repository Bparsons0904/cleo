...
class _FilterSortBottomSheetState extends ConsumerState<FilterSortBottomSheet> {
  ...
  Widget _buildSortOption({
    ...
    return RadioListTile<CollectionSortOption>(
      ...
      onChanged: (newValue) {
        setState(() {
          _tempFilterState = _tempFilterState.copyWith(sortOption: newValue);
        });
      },
      ...
      onChanged: (bool? value) {
        setState(() {
          final updatedGenres = List<String>.from(
            _tempFilterState.selectedGenres,
          );
          ...
          Expanded(
            child: ElevatedButton(
              onPressed: () {
                ...
                if (_tempFilterState.playStatus !=
                    ref.read(collectionFilterProvider).playStatus) {
